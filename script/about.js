               ...
               if(experience) {
                ...
                const educationList = [
                    ...
                    },
                    {
                        ...
                        institution: "Maaharashtra State Board of Technical Education",
                        details: "Completed Diploma in Medical Electronics with a focus on science and analytical subjects, building a foundation for Hospital Eqipments studies."
                    },
                    {
                        id: 3,
                        date: "2019",
                ...
                const skillList = [
                        { id: 1, name: "HTML5", icon: "HTML.jpeg" },
                        { id: 2, name: "CSS3", icon: "css3.svg" },
                        { id: 3, name: "JavaScript", icon: "JavaScript.jpeg" },
                        { id: 4, name: "React (Basics)", icon: "React.jpeg" },
                        ...
                        { id: 7, name: "SQL & Databases", icon: "SQL.jpeg" },
